...
Welcome to `dctkit` contributor's guide.
...
If you experience bugs or general issues with `dctkit`, please have a look
...
You can help improve `dctkit` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`dctkit` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `dctkit`'s files. While this mechanism can
...
```
conda create -n dctkit python=3 six virtualenv pytest pytest-cov
conda activate dctkit
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/dctkit.git
   cd dctkit
   ```
...
5. Install [pre-commit]:
   ...
   `dctkit` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/dctkit
[issue tracker]: https://github.com/<USERNAME>/dctkit/issues
